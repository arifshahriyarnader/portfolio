      ...
      <div className="flex flex-col lg:flex-row gap-12 max-w-7xl mx-auto">
        <div className="lg:w-1/2">
          ...
          >
            ...
            creating modern, responsive applications using cutting-edge
            technologies. My journey started with a passion for both code and
            design, which has shaped my approach to building user-centered
            solutions.
          </p>
          <p
            className={`text-md mb-8 
              ${theme === "light" ? "text-gray-600" : "text-gray-400"}`}
          >
            I believe in the power of clean, efficient code and intuitive
            design. Whether it&apos;s a complex web application or a simple
            landing page, I strive to deliver solutions that not only look great
